    ...
    <div className="platform-bg">
        ...
        <div className="sidebar-container">
          ...
          <div className="sidebar-lower">
            <div className="sidebar-inactive" >
              <img src={supportIcon} alt="" className="image-mini"/>
              <p>Support</p>
            </div>
            <div className="sidebar-inactive" >
              <img src={DocIcon} alt="" className="image-mini"/>
              <p>Documentation</p>
            </div>
            <div className="sidebar-inactive" >
              <img src={AccountIcon} alt="" className="image-mini"/>
              <p>My Account</p>
            </div>
          </div>
        </div>
      ...
      <div className="platform-main">
        <div className="platform-navbar">
          <div className="platform-greet">
            <p>Welcome Back Kumar!</p>
          </div>
          <div className="platform-navmenu">
            <form>
              <input className="platform-search" type="text" name="name" placeholder="Search..." />
            </form>
            <div className="navmemu-content" >
              <VscBellDot />
            </div>
            <div className="navmemu-content" >
